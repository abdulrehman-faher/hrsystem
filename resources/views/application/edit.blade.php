...
<section class="content">
    <div class="container-fluid">
        <form method="POST" id="application_create_form" action="{{route('application.update', ['application' => $application->id])}}" class="needs-validation" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control {{ $errors->has('cnic') ? 'is-invalid' : ''}}" id="cnic" name="cnic" value="{{ old('cnic', $application->cnic) }}" data-inputmask="'mask': ['99999-9999999-9', '999999-999999-9']" data-mask oninvalid="this.setCustomValidity('CNIC is required')" oninput="this.setCustomValidity('')" required />
                    @error('cnic')
